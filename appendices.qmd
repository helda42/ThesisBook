...
![Plasmodium falciparum parasite prevalence (PfPR) survey data from the malaria indicator survey by enumeration area (EA) for Chikwawa, Malawi, 2017.](figures/9_images/EPIMALClusters Mal Prev2017 (1).png){#fig-MIS2017 width="617"}
...
![Acquisition of STm OAg IgG in children recruited into the SAINTS study vs iNTS incidence from QECH-MLW blood culture service Blantyre, Malawi in children (0-5 years)](figures/9_images/inverseAbiNTS.png){#fig-inverseiNTSAb width="890"}
