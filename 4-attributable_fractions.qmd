...
```
```{r echo=FALSE, message=FALSE, results='hide',warning=FALSE, fig.align = "center", fig.height = 7, fig.width = 6.5, out.width = "6.5in"}
# library(PRISMA2020)
# library(here)
# library(rio)
...
gtsummary::tbl_summary(descrip_sum_tab, digits = all_continuous() ~ 1) %>% 
  as_gt()
...
```{r echo=FALSE, results='hide', message=FALSE, fig.align = "left", fig.height = 6, fig.width = 10, out.width = "10.5in"}
