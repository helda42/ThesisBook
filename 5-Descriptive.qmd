...
min_age_MRDT_m <- sum_MRDT_3m_m %>% slice_min(MRDT_all_per)
max_age_MRDT_m <- sum_MRDT_3m_m %>% slice_max(MRDT_all_per)
...
Malaria rapid diagnostic (MRDT) was positive in `{r} MRDT$MDRT_tot` (`{r} MRDT$MRDT_all_per`%); `{r} min_mth_MRDT_c$MDRT_tot` (`{r} min_mth_MRDT_c$MRDT_all_per`%) in Chikwawa and `{r} min_mth_MRDT_m$MDRT_tot` (`{r} min_mth_MRDT_m$MRDT_all_per`%) in St Montfort (@fig-MRDT A). In Chikwawa, children in the age group `{r} min_mth_MRDT_c$AGEGROUP_3mth` months (mean `{r} min_mth_MRDT_c$age_mean` months) had MRDT positive results in `{r} min_mth_MRDT_c$MDRT_tot` (`{r} min_mth_MRDT_c$MRDT_all_per`%) , and age group `{r} max_age_MRDT_c$AGEGROUP_3mth` months (mean `{r} min_age_MRDT_c$age_mean` months) had `{r} max_age_MRDT_c$MDRT_tot` (`{r} max_age_MRDT_c$MRDT_all_per`%). In St Montfort, children in the age group `{r} min_age_MRDT_m$AGEGROUP_3mth` months (mean `{r} min_age_MRDT_m$age_mean` months) had MRDT positive results in `{r} min_age_MRDT_m$MDRT_tot` (`{r} min_age_MRDT_m$MRDT_all_per`%) , and age group `{r} max_age_MRDT_m$AGEGROUP_3mth` months (mean `{r} min_age_MRDT_m$age_mean` months) had `{r} max_age_MRDT_m$MDRT_tot` (`{r} max_age_MRDT_m$MRDT_all_per`%) (@fig-MRDT B).
