...
#   ggplot() +
#     geom_bar(aes(salm_fact), fill="dark green") +
#     theme_bw() +
...
![Salmonella stool culture results by 3 month age group in children 0 - 60 months in children recruited in the SAiNTS study, Chikwawa, Malawi](images/clipboard-4586853.png){#fig-NTSculture width="601"}
