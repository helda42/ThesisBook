...
master <- import(here("data", "5_data", "master.csv")) %>% 
  ...
  mutate(
          # AGEGROUP_3mth = fct_relevel(AGEGROUP_3mth, c("[0,3]", "(3,6]","(6,9]","(9,12]","(12,15]", "(15,18]", "(18,21]","(21,24]",
          ...
          AGEGROUP_3mth = factor(AGEGROUP_3mth, levels = c("[0,3]", "(3,6]","(6,9]","(9,12]","(12,15]", "(15,18]", "(18,21]","(21,24]","(24,27]", "(27,30]",
                          ...
                          labels = c("0-3", "3-6", "6-9", "9-12","12-15", "15-18","18-21","21-24","24-27","27-30","30-33","33-36","36-39","39-42","42-45","45-48",
                                     "48-51","51-54","54-57","57-60")),
...
pcomb_clus <- sum_stoolseason_long_clst %>% 
  ggplot(aes(x=factor(month_yr), y=Percent, fill=Method)) +
    geom_bar(position="dodge", stat="identity")+
    scale_fill_manual(values = c("Salm_pos_percent" = "coral", "PCR_pos_percent" = "seagreen"), labels=c("Culture Positive", "PCR Positive"))+
    theme_bw() +
    theme(axis.text=element_text(size=6),
          axis.title=element_text(size=6,face="bold"),
          legend.text=element_text(size=6),
...
These results show an increasing  continuing community exposure to *Salmonella* and malaria iNTS incidence increases rapidly in early life, but begins to fall between 18-36 months, 
