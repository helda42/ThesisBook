...
#| label: fig-malHL
#| 
H <- ggPlotFun(fit=fitList_malaria[["STmH5"]],fit2=fitList_malaria[["STmH5"]], strain="≥5%",varNameOrigNum=paste(sep="","STmH5","_num"),colModel="darkgreen",colModelCI="darkgreen",colChangepoints="orchid",c="STmH5",s="STm")$g
